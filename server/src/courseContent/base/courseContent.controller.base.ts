...
export class CourseContentControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: CourseContent })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Body() data: CourseContentCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [CourseContent] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(CourseContentFindManyArgs)
  async findMany(
    @common.Req() request: Request,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<CourseContent[]> {
    const args = plainToClass(CourseContentFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: CourseContentWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ...
  async findManyChapters(
    @common.Req() request: Request,
    @common.Param() params: CourseContentWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<CourseChapter[]> {
    const query = plainToClass(CourseChapterFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
  ...
  async createChapters(
    @common.Param() params: CourseContentWhereUniqueInput,
    @common.Body() body: CourseContentWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      chapters: {
    ...
    if (invalidAttributes.length) {
      ...
      throw new common.ForbiddenException(
        `Updating the relationship: ${
          invalidAttributes[0]
        } of ${"CourseContent"} is forbidden for roles: ${roles}`
      );
    }
  ...
  async updateChapters(
    @common.Param() params: CourseContentWhereUniqueInput,
    @common.Body() body: CourseChapterWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
    const data = {
      chapters: {
