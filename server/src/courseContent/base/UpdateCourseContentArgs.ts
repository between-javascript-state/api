...
@ArgsType()
class UpdateCourseContentArgs {
  @Field(() => CourseContentWhereUniqueInput, { nullable: false })
  where!: CourseContentWhereUniqueInput;
  @Field(() => CourseContentUpdateInput, { nullable: false })
  data!: CourseContentUpdateInput;
}

export { UpdateCourseContentArgs };
